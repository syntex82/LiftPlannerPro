...
export default function CADError({
  ...
  useEffect(() => {
    console.error('CAD Editor error:', error)
  }, [error])
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-slate-800/50 border-slate-700">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-white text-xl">CAD Editor Error</CardTitle>
          <CardDescription className="text-slate-400">
            There was a problem loading the CAD editor.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="p-3 bg-blue-900/20 border border-blue-600/30 rounded">
            <div className="flex items-center gap-2 text-blue-400 text-sm">
              ...
              <span>CAD Editor works best on desktop devices</span>
            </div>
          </div>
