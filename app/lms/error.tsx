    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-slate-800/50 border-slate-700">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-white text-xl">Learning System Error</CardTitle>
          <CardDescription className="text-slate-400">
            There was a problem loading the Learning Management System.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="p-3 bg-green-900/20 border border-green-600/30 rounded">
            <div className="flex items-center gap-2 text-green-400 text-sm">
              ...
              <span>Your learning progress is saved</span>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-slate-500 text-sm">
              Your quiz progress and certificates are safe.
            </p>
          </div>
        </CardContent>
      </Card>
